...
import kz.javaee.project.mirasazharitis1908.EntityManager;
...
import kz.javaee.project.mirasazharitis1908.repository.UserRepository;
...
public class UserRepositoryImpl implements UserRepository {
  ...
  public User authenticate(String login, String password) {
    ...
    try {
      String sql = String.format("SELECT u FROM User u WHERE u.login = '%s' AND u.password = '%s'",
          login, password);
